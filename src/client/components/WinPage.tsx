...
export const WinPage: React.FC<WinPageProps> = ({ playerTime, leaderboard, onPlayAgain }) => {
    ...
    <div className="fixed inset-0 pointer-events-none overflow-hidden">
      {Array.from({ length: 50 }, (_, i) => (
        ...
        >
          <div
            className={`w-3 h-3 ${
              ['bg-blue-400', 'bg-purple-400', 'bg-green-400', 'bg-yellow-400', 'bg-pink-400'][
              ...
              {leaderboard.slice(0, 10).map((player, index) => (
                <div 
                  ...
                  className={`flex justify-between items-center p-2 rounded ${
                    player.name === 'You' && player.time === playerTime 
